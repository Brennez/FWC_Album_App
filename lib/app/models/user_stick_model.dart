...
class UserStickModel {
  ...
  factory UserStickModel.fromMap(Map<String, dynamic> map) {
    return UserStickModel(
      id: map['id']?.toInt() ?? 0,
  ...
  factory UserStickModel.fromJson(String source) =>
      UserStickModel.fromMap(json.decode(source));
}
